...
def main(config_path: str, coarse_ckpt_path: str | None, run_dir_arg: str | None = None):
    ...
    run_dir = run_dir_arg or os.path.join("runs", "mamba_with_flow")
...
if __name__ == "__main__":
    args = parse_args()
    main(args.config, args.coarse_ckpt, args.run_dir)
